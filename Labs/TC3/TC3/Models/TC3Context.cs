...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.CustomerCardId)
                    .HasName("PK__Customer__8C1C23B16CB09A1F");

                entity.ToTable("Customer_Cards", "TC3");
                ...
                entity.Property(e => e.Preferred).HasColumnName("preferred");

                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.CustomerCards)
                    .HasForeignKey(d => d.CustomerId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Customer___custo__3D5E1FD2");
            });
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Customer__AB6E61640D22A709")
                    .IsUnique();
            ...
            modelBuilder.Entity<PaymentType>(entity =>
            {
                entity.HasKey(e => e.PaymentTypeId)
                    .HasName("PK__Payment___8C1ABD6FDABB46DF");

                entity.ToTable("Payment_Types", "TC3");
            ...
            modelBuilder.Entity<SalesOrder>(entity =>
            {
                ...
                entity.HasOne(d => d.PaymentType)
                    ...
                    .HasConstraintName("FK__Sales_Ord__payme__48CFD27E");
            });
        }
    }
}
